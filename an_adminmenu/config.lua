...
Config.useQBnotif = false -- use built-in QBCore notifications -- only works with QBCore !!

Config.useCustomNotif = true -- use custom notification -- Edit "function CustomNotif(text,type)" below
